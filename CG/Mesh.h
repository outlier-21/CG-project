	...
	void Draw(Shader shader)
	{
		...
		for (unsigned int i = 0; i < textures.size(); i++)
		{
			...
			if (name == "texture_diffuse")
				...
				number = std::to_string(specularNr++); 			else if (name == "texture_normal")
				number = std::to_string(normalNr++); 			else if (name == "texture_height")
				number = std::to_string(heightNr++); 			else if (name == "texture_reflect")
